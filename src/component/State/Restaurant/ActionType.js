...
export const UPDATE_RESTAURANT_REQUEST = "CREATE_RESTAURANT_REQUEST";
export const UPDATE_RESTAURANT_SUCCESS = "CREATE_RESTAURANT_SUCCESS";
export const UPDATE_RESTAURANT_FAILURE = "CREATE_RESTAURANT_FAILURE";
